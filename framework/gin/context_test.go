...
import (
	...
	testdata "github.com/developbiao/webcore-demo/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/developbiao/webcore-demo/framework/gin.handlerNameTest$", c.HandlerName())
}
